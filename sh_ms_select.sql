...
(SELECT 文章序號 FROM [DcBid].[dbo].[flea] WHERE 日期時間 >= '2014-06-01' AND 文章序號 IS NOT NULL)
...
(SELECT TOP 100 文章序號 FROM [DcBid].[dbo].[flea] WHERE 日期時間 >= '2014-06-01' AND 文章序號 IS NOT NULL
ORDER BY 文章序號 DESC)
